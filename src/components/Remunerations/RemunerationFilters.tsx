// src/components/Remunerations/RemunerationFilters.tsx
...
interface RemunerationFiltersProps {
  searchTerm: string;
...
export default function RemunerationFilters({
  searchTerm,
  onSearchChange,
  employeeFilter,
  onEmployeeFilterChange,
  employees,
}: RemunerationFiltersProps) {
  return (
    <div className="flex flex-col gap-4 p-4 bg-white border border-gray-200 rounded-2xl dark:border-gray-800 dark:bg-white/[0.03] sm:flex-row sm:items-center sm:justify-between">
      <div className="relative flex-1">
        ...
        <input
          ...
          placeholder="Buscar por funcionário ou tipo de remuneração..."
